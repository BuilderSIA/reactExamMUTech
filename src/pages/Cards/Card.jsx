 ...
 const {addCart, inc, dec} = UseGlobalContext()
    ...
    return (
       <div className="container-card">
            ...
            <button className='home-card-button cta' onClick={()=>addCart(id)}><span className="hover-underline-animation"> Shop now </span>
    <svg className='svg-button' viewBox="0 0 46 16" height="15px" width="23px" xmlns="http://www.w3.org/2000/svg" id="arrow-horizontal">
